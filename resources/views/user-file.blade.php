    ...
    <div class="card-header">Upload File</div>
            @if ($message = Session::get('success'))
                <div class="alert alert-success alert-block">
                    ...
                    <!-- Display Uploaded file, if the uploadFilename session variable is set -->
        ...
        <!--
        Image
        <img src="{{asset('storage/uploads/ndYw8bPdXrjcDbR0EXg2N2OQPw4e3al3oznZVcy0.jpeg')}}"  width="100px;" alt="asset"><br>
        -->
